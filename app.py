...
# Custom styled title
st.markdown('<p style="color: #222222; font-size: 36px; font-weight: bold;">🎮 Steam Game Recommendation System</p>', unsafe_allow_html=True)
...
st.markdown('<p style="font-size: 24px; font-weight: bold; color: #222222;">🔴 Type in game name:</p>', unsafe_allow_html=True)
