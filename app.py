...
# Custom styled title
st.markdown('<p style="color: #222222; font-size: 36px; font-weight: bold; text-shadow: 2px 2px 4px #ffffff;">🎮 Steam Game Recommendation System</p>', unsafe_allow_html=True)
...
st.markdown('<p style="font-size: 24px; font-weight: bold; color: #222222;text-shadow: 2px 2px 4px #ffffff;">🔴 Type in game name:</p>', unsafe_allow_html=True)
...
if selected_game:
    ...
    if recs.empty:
        ...
        st.markdown(f'<h3 style=font-weight: bold; color: #222222;text-shadow: 2px 2px 4px #ffffff;">🎯 Recommendations for {name}:</h3>', unsafe_allow_html=True)
